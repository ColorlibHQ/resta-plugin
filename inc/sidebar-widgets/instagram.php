...
----------------------------------------*/
class resta_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('resta_instagram_photo',esc_html__('[ Resta ] Intagram Photo','resta-companion'),array(
			'description' => esc_html__('Resta Instagram Photo Widget','resta-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'resta-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'resta-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'resta-companion'); ?></label>
...
if(!function_exists('resta_instagram_widgets')):
	function resta_instagram_widgets(){
		register_widget('resta_instagram_photo');
	}
	add_action('widgets_init','resta_instagram_widgets');
endif;
