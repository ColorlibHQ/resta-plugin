...
class Resta_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Resta ] Social Links', 'resta-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'resta-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'resta-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'resta-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'resta-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'resta-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'resta-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'resta-companion'); ?></label>
...
} // Class resta_social_links ends here


// Register and load the widget
function resta_social_links_widget_load() {
	register_widget( 'Resta_social_links' );
}
add_action( 'widgets_init', 'resta_social_links_widget_load' );